...
We provide a Docker container that encapsulates software executables and data used to perform the experiments described in the paper, documentat, and additional supplementary files.
